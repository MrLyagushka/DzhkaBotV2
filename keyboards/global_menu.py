...
global_menu_choice_class = Menu('reply', 2)
global_menu_choice_class.new_button('5', 1)
global_menu_choice_class.new_button('6', 1)
global_menu_choice_class.new_button('7', 1)
global_menu_choice_class.new_button('8', 1)
global_menu_choice_class.new_button('9', 2)
global_menu_choice_class.new_button('10', 2)
global_menu_choice_class.new_button('11', 2)