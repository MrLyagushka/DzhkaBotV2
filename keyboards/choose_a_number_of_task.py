...
keyboard_list_a_number_of_task = Menu('reply', 7, one_time_keyboard=True)
...
keyboard_list_a_number_of_task.new_button('№7', 2)
...
keyboard_list_a_number_of_task.new_button('№13', 3)
keyboard_list_a_number_of_task.new_button('№14', 3)
...
keyboard_list_a_number_of_task.new_button('№19', 4)
keyboard_list_a_number_of_task.new_button('№20', 4)
keyboard_list_a_number_of_task.new_button('№21', 4)
keyboard_list_a_number_of_task.new_button('№22', 4)

keyboard_list_a_number_of_task.new_button('№23', 5)
keyboard_list_a_number_of_task.new_button('№24', 5)
keyboard_list_a_number_of_task.new_button('№25', 5)
keyboard_list_a_number_of_task.new_button('№26', 5)

keyboard_list_a_number_of_task.new_button('На главное меню', 6)
